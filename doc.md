...
2024-06-13: I think one of the important things here is to have a good guided audio track. I'd like to produce one at some point. One of the problems I am seeing with both my document here, and e.g. Simon Spire's LNB Reference Guide, is that they are both written words, so it's hard to sync it up with realtime. Instead of saying "just loop through these instructions", it's nice to have that work offloaded to the audio track creator, and just be focusing on the present moment, having the instructions do the cognitive work of figuring out what to do when, so that you can just focus on fixing your breathing.
