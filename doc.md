...
- "suffocation": where i feel like i'm not even breathing air, i'm breathing some other substance, so even when i take rescue breaths, it doesn't feel good. you feel the air hunger even when you're inhaling. 2025-01-23: nuts, I just had this type of air hunger, and described it to someone as "it feels like the air i'm breathing isn't real air"; it was uncanny to see that i had described the exact same thing in the exact same way and then forgot about it.
...
1. Initially, because I was still mouth-breathing a significant percentage of the time (20%?), my constraint was to do nasal breathing. _Any_ nasal breathing. The goal was simply to get away from the habit of mouth breathing. Nasal breathing is a good first target because (a) it's extremely obvious whether any particular breath happens through the nose or mouth; and (b) on its own it already has pretty dramatic effects (see @nestor2020 for a lot more detail on this). Achieving nose breathing itself occurs in two stages:
    - Consciously do nasal breathing. You use any and all tools you have to try to nose breathe: just anxiously paying attention all the time, nasal strips (nasal splints), nose cones (nasal cones), nasal dilators, azelastine, NeilMed, allergy sheets, etc. (Flonase is another option that _might_ help people but it didn't work for me because of side-effects and there's a chance it builds up a dependence even though it's not supposed to?) You want to get to a point where the only times you mouth breathe are when you have to blow your nose, when you swim, when you take a shower, or things like that. I nose breathe even with a mask on, even when I'm brushing my teeth, and as much as possible even in my sleep (mouth taping or a chin strap might help with this). (This step took around 1 month for me.)
...
It's very important to keep in mind that most of these strategies (namely nasal wash, mechanical dilation, and medication, but not Buteyko-style breathing and nose unblocking exercises) are _slightly evil short-term hacks_. They aren't _hugely_ harmful when used occasionally or in the early stages of fixing your breathing pattern, as far as I can tell, but I think they do cause some harm in the sense that closed up nasal passages are a signal from your body that you are overbreathing, and by forcing your nose open, you are disregarding what your body is trying to tell you. It would be as if you had a cold and you were feeling fatigued (i.e. a signal from your body to take rest), but you drank a bunch of coffee and took stimulants so that you could work out anyway. So you don't want to just keep relying on these strategies long-term; your goal should be to improve your normal, unconscious breathing to the point where you're always doing silent nasal breathing. But early on, as a way to avoid mouth breathing (which is basically like mechanical dilation on steroids, so even worse than the hacks in this section), I think these strategies are fine to use.
...
- Nose strips (also sometimes called nasal strips or nasal splints): these were quite helpful. at first i used the RiteAid brand ones and they worked well enough, and then i got cheaper ones from Amazon and those also worked fine. so my guess is that there isn't much of a quality difference between different brands, and you can just go with whatever. the main thing to watch for is that your skin should not get irritated from using them. also, you should _immediately_ notice an improvement. if you don't immediately breathe better, then you're either not putting them on right or the thing isn't working. There is also a magnetic strip made by a company called Intake Breathing. I never used it so I don't know how well it works, but if you can't get regular nose strips to work, you can look into this.
- Nose cones (also called nasal cones): these didn't work for me (i got them because i was encouraged by how useful the nose strips were, and cones seemed like reusable strips). they don't go deep enough in the nose, so they really only help i think if you have a deviated septum or something...
- Nasal dilators: I didn't try these, but you can check out [this video](https://youtu.be/tPz7jxlkb0I) for some examples. Note that the video doesn't use the term "nasal cones" and instead just calls everything "dilators", wheres in this document I've distinguished cones from the more "clip-like" dilators. The video mentions that these cones/dilators can become covered in mucus -- but that's a signal from your body that you're overbreathing, and the mucus is trying to clog up your nostrils to make you breathe less! So watch out for signals like this from your body.
...
- TODO: experiment with things that "hit the nose" like vinegar and wasabi
...
## Mouth taping and chin strapping
...
A particularly bad instance of the mucus version happened on the night of 2025-12-23. I had a "sensory whackamole" where I cycled through can't breathe $\to$ sitting up so I could breathe $\to$ feeling cold $\to$ lying down (under covers, so warmer) $\to$ mucus clogged, can't breathe $\to$ sitting back up $\to$ feeling bored $\to$ reading on phone $\to$ too tired to actually read $\to$ lying back down $\to$ mucus clogged $\to$ trying to breathe harder $\to$ chest and diaphragm hurt $\to$ sitting back up $\to$ etc. etc. etc. for like 3 hours.
...
(Further rant on Buteyko pedagogy: some buteyko-oriented teachers don't emphasize relaxation enough. Buteyko breathing is more about relaxation than it is about breathing. You really do not want to restrict your breathing by tensing up more; that's just going to make the air hunger worse. The Russian-lineage buteyko practitioners tend to be better in this regard, as they make sure to tell you to relax as you reduce your breathing. However, the problem with buteyko pedagogy in general is that it's not really tailored to people with air hunger or people with a hypersensitive nervous system (such as those resulting from a post-viral illness), so it just kind of assumes you can do the exercises or can take your CP, and even that you can "just breathe less", or that you can pay attention to your breathing without massively messing things up. People with air hunger issues (including myself) can find it very hard to measure their CP. Notice that in this document, this main practice is to be done _after_ you're already nasal breathing, _after_ you've gotten comfortable with short breath holds, etc. And this is considered the most gentle of the buteyko exercises, so if this was a buteyko document, it would be the first exercise that would be taught. When you have air hunger, the gentler the better.)
...
2025-04-06: ok, so i think the thing that feels off about the alexander technique people (e.g. simon spire) and the muscle tension people (e.g. the postural restoration institute) people is that they just kind of assume that you can intentionally let go of tension. like, they assume you can JUST stop trying to strain for deep breaths. and partly this is what is going on for people who overbreathe, and for some it may be enough. but you really need to ask "where is the tension coming from?" From a post-viral nervous system dysregulation perspective (which is where i'm coming from), the root cause is the nervous system stuff, and the nervous system activation is what is _causing_ the straining for breath (brain thinks it is in danger, need to fight or flee), which leads to muscle tension. letting go of that tension isn't going to magically fix things; it will work until the next time your nervous system gets activated (from doing mundane things like talking out loud or programming or even reading, in my case). it's the nervous system that needs to be worked on, to get it to perceive less danger (dan buglio's term) in these mundane activities. and so this is where brain retraining comes in.
...
- Am I talking too much, or exerting myself (physically, mentally, emotionally) too much in some way? If so, I can just try to drop everything, and sit or stand or lie down and close my eyes and just not do anything for a while.
...
- Can I relax some part of my body, or (if some parts of my body are already relaxed) _more_ parts of my body? Especially on the exhale.
