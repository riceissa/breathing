...
docs/index.html: index.md
	pandoc -f markdown -t html5 --mathjax --toc --citeproc --bibliography references.bib -M maxwidth:40em -M mainfont:Georgia -M fontsize:18px -M linestretch:1.3 --standalone -o "$@" "$<"
